...
export function Musically() {
  return (
    <div className=" relative w-full mt-[-5rem]  bg-transparent flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div>
        <h1
          className=" text-[4rem] mt-[12rem]  lg:text-9xl 
      font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50"
        >
          Musically
        </h1>
      </div>
      ...
      <div className="mt-[-6.5rem] md:mt-[-14rem] lg:mt-[-14rem]">
        <h1
          className="text-[2rem]  md:text-7xl lg:text-7xl font-bold
      ...
      <div className=" md:mt-[-2rem] flex flex-col gap-1 justify-center items-center">
        <p
          className=" font-normal mt-[3.5rem] lg:mt-20 text-base
       text-neutral-300 max-w-lg text-center mx-auto z-50
       "
        >
